...
<div class="sidebar">
    ...
    <nav class="nav flex-column">
        ...
        <a class="nav-link position-relative <?php echo $current_page == '../view/reports.php' ? 'active' : ''; ?>" href="reports.php">
            <i class="fas fa-flag me-2"></i>Reports
            <?php if ($pending_reports > 0): ?>
                <span class="badge-notification"><?php echo $pending_reports; ?></span>
            <?php endif; ?>
        </a>
        <a class="nav-link <?php echo $current_page == '../view/analytics.php' ? 'active' : ''; ?>" href="analytics.php">
